...
warstwie 3.). W przeciwieństwie do standardowego bridgowania
bridgowanie proxy ARP pozwala na bridgowanie sieci ethernetowych za
bezprzewodowymi węzłami. Normalne bridgowanie w warstwie 2. nie działa
pomiędzy węzłami bezprzewodowymi ponieważ nie znają one adresów MAC
używanych w przewodowych sieciach Ethernet.
